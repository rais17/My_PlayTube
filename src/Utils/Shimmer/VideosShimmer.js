    ...
    <div className='flex flex-wrap justify-center w-full min-h-screen gap-6 px-3'>
      {
        Array.from({ length: 12 }).map((element, index) => {
          return (
            ...
            >
              <div className="flex aspect-video w-full items-center justify-center rounded bg-gray-300 dark:bg-[#1f1f1f]">
                <svg
              ...
              <div className="w-full">
                <div className="mb-3 h-2.5 w-48 rounded-full bg-gray-200 dark:bg-[#1f1f1f]"></div>
                <div className="mb-2.5 h-2 rounded-full bg-gray-200 dark:bg-[#1f1f1f]"></div>
                <div className="h-2 max-w-[360px] rounded-full bg-gray-200 dark:bg-[#1f1f1f]"></div>
              </div>
